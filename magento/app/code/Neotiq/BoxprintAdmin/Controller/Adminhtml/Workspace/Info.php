...
class Info extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!$this->getRequest()->isAjax() || empty($params)) {
            ...
            $res = [];
            $res['mdq_boxprint_info'] = $this->_view->getLayout()->createBlock('Magento\Framework\View\Element\Template')->setTemplate('Neotiq_BoxprintAdmin::mdq_workspace_info.phtml')->setWorkspaceId($params['workspaceId'])->setProductId($params['productId'])->toHtml();
